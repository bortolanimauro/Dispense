...
Ecco come definiamo la classe Ostacolo nel nostro progetto:

\begin{lstlisting}[caption={Classe Ostacolo}]
public class Ostacolo
{
    // Le coordinate dell'ostacolo
    public int x0, y0; // Angolo in alto a sinistra
    public int x1, y1; // Angolo in basso a destra
    public Color colore; // Il colore del rettangolo
    
    // Il costruttore: come nasce l'ostacolo
    public Ostacolo(int inizioX, int inizioY, 
                    int fineX, int fineY)
    {
        x0 = inizioX;
